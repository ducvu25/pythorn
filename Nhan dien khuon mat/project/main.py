...
for name in list_anh:
    ...
    classNames.append(name[0:name.index("_number")]) # tach ten
#print(classNames)
...
# doc dữ liệu những người đã tham dự
with open("baocao.txt", "r+") as f:
    ...
    if (len(myDatalist) > 0):
        for line in myDatalist:
            ...
            DSten.append(ten[0])
    # khởi động cam
    cap = cv2.VideoCapture(f"{canCheck}/video.mp4")
    while 1:
        ret, frame = cap.read()
